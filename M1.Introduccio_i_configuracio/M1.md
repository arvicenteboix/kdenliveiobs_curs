...
- Controls: Ací hem destacat dos botons que seran els que utilitzarem principalment, _Iniciar gravació_ i _Iniciar càmera virtual_. El primer ens permetrà començar a gravar la nostra pantalla i el segon ens permetrà començar a utilitzar la càmera virtual.
...
:::note
OBS disposa de nombrosos plugins que vos poden ajudar a fer tasques concretes. Aquests plugins estan en constant evolució, si els enllaços no funcionen simplement busqueu en la pàgina de [recursos](https://obsproject.com/forum/resources/) de OBS i els busque, ja que probablement els hagen actualitzat.
:::
...
Vos recomanem que instal·leu els dos models si és possible, moltes vegades per temes de versions de python, confiugració de l'ordinador, etc... pot donar problemes. Per a instal·lar-los anem al següent menú: (en la nova versió la ruta és Secuència/subtítols/Reconeiximent de veu)
...
Podràs veure la següent pantalla: (en la nova versió la ruta és Preferències/Configuració Kdenlive/Plugins)
