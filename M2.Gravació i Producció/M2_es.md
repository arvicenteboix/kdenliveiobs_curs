...
En esta unidad ya nos vamos a centrar concretamente en un ejemplo concreto de producción de un videotutorial. No vamos a centrarnos en ningún aspecto concreto y trataremos de dar varias opciones para que cada uno pueda adaptarlo a sus necesidades.
...
Con la fuente navegadora podemos tener un navegador integrado en nuestra escena. Eso sí, si queremos interactuar con el navegador mejor utilizar una captura de ventana, ya que es más sencillo.
...
La mascarilla también acepta difuminación, para que no se vea tan bruscamente el recortado.
...
Fijémonos que hemos escogido el modelo Whisper Small, es un modelo que pesa poco y funciona bastante bien, en idioma de entrada lo hemos dejado con "Auto-detect" pero es recomendable que elija el idioma con el que va a hablar. Este filtro también nos permite realizar traducciones simultáneas de los subtítulos, de manera que puede hacer una charla en castellano que los subtítulos estén en inglés.
